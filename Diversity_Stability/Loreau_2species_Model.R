...
model <- function(rm1, rm2, N1.start, N2.start, K1, K2, evar1, evar2, beat12, beta21, time){
  r1 = numeric(time)
  r2 = numeric(time)
  N1 = numeric(time)
  N2 = numeric(time)
...
model.null <- model(rm1, rm2, N1.start, N2.start, K1, K2, evar1, evar2, beat12, beta21, time)
